...
std::vector<std::pair<std::wstring, DWORD>> ProcessUtils::EnumerateProcesses() {
...
HANDLE ProcessUtils::OpenProcessByName(const std::wstring &process_name) {
...
DWORD ProcessUtils::FindProcessId(const std::wstring& process_name) {
